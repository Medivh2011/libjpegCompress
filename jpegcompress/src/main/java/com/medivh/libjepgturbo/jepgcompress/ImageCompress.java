...
public class ImageCompress implements Handler.Callback{
    ...
    private final int DEFAULT_QUAILTY = 100;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    int quailty = mBuilder.quality == 0?DEFAULT_QUAILTY:mBuilder.quality;
                    String targetCompressPath = getImageCacheFile(checkSuffix(mBuilder.filePath));
                    String resultStr = BitmapUtil.compressBitmap(mBuilder.filePath, targetCompressPath, quailty,ignoreSize);
